...
const PatientDashboard = () => {
  ...
  const { list: appointments, loading: aptLoading } = useSelector(
    (state) => state.appointments
  );
  const { list: records, loading: recLoading } = useSelector(
  ...
  const nextAppointment =
    appointments
      ?.filter((apt) => ["Pending", "Scheduled", "Confirmed"].includes(apt.status))
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-[11px] text-muted-foreground">
                OPD visits, notes & prescriptions
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-[11px] text-muted-foreground">
                Access via <span className="font-medium">AI Assistant</span> in sidebar.
              </p>
            </CardContent>
          </Card>
        </div>
