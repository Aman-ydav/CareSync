      ...
      <div className="container mx-auto px-4 space-y-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {quickActions.map((action, index) => (
                ...
                >
                  <Card className="premium-card h-full cursor-pointer group border-2 border-transparent hover:border-primary/20 transition-all">
                    <CardContent className="p-6">
                ...
                <CardContent className="p-6">
                  <div className="space-y-4">
                    {upcomingAppointments.map((appointment) => {
                      ...
                      return (
                        <div key={appointment.id} className="flex items-center justify-between p-4 rounded-lg bg-muted/50 hover:bg-muted/70 transition-colors">
          ...
          >
            ...
            {/* Health Tips */}
            <Card className="premium-card bg-linear-to-br from-primary/5 to-accent/5">
              <CardHeader>
